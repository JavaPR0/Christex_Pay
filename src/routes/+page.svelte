...
<div class="bg-gray-900">
    <main>
      ...
      <div class="relative isolate overflow-hidden">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
          <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
            ...
            <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">Swap USDC to SLL & SLL to USDC</h1>
            <p class="mt-6 text-lg leading-8 text-gray-300">An application that allows users to swap USDC to mobile money and vice versa, with user registration, purchase, conversion, and transaction history features is a multi-step process.</p>
      ...
      <div class="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
        <h2 class="text-center text-lg font-semibold leading-8 text-white">You can swap with</h2>
