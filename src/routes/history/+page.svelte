  ...
  <main>
    <div class="relative isolate overflow-hidden pt-0">
      ...
      <div class="border-b border-b-gray-900/10 lg:border-t lg:border-t-gray-900/5">
        <dl class="mx-auto grid max-w-7xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:px-2 xl:px-0">
          <div class="flex items-baseline flex-wrap justify-center gap-y-2 gap-x-4 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8">
            <dt class="text-sm font-medium leading-6 text-gray-500">Total Transaction</dt>
            <dd class="w-full flex-none text-4xl font-medium leading-10 tracking-tight text-gray-900" style="text-align: center;">$500.00</dd> 
          </div>
          <div class="flex items-baseline flex-wrap justify-center gap-y-2 gap-x-4 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8 sm:border-l">
            <dt class="text-sm font-medium leading-6 text-gray-500">Total Incoming Transaction</dt>
            <dd class="w-full flex-none text-4xl font-medium leading-10 tracking-tight text-gray-900" style="text-align: center;">$500.00</dd> 
          </div>
          <div class="flex items-baseline flex-wrap justify-center gap-y-2 gap-x-4 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8 lg:border-l">
            <dt class="text-sm font-medium leading-6 text-gray-500">Total Outgoing Transaction</dt>
            <dd class="w-full flex-none text-4xl font-medium leading-10 tracking-tight text-gray-900" style="text-align: center;">$500.00</dd> 
          </div>
        </dl>
      </div>
